...
DESC STORAGE INTEGRATION s3_data_integration;

SHOW STAGES LIKE 'S3DATA_STAGE' IN SCHEMA SNOWFLAKE_LEARNING_DB.ADMIN_LOAD_DATA_FROM_AMAZON_AWS;
...
CREATE OR REPLACE STAGE s3data_stage
